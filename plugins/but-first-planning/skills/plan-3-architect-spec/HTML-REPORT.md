...
- **Report title**: "Spec architecture review" when run by plan-3-architect-spec (you're visualising a design — the before/after diagrams show how designed modules and seams change); "Architecture review" when run by build-improve-architecture (you're visualising a codebase).
