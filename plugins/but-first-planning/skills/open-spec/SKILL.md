...
```bash
bash "${CLAUDE_PLUGIN_ROOT}/skills/open-spec/open-spec.sh"
```
...
scaffolded yet: point the user at `plan-0-init`. If the server never comes up,
