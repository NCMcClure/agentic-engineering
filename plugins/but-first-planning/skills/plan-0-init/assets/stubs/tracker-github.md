...
Ongoing Status transitions are **not** done by hand or by `plan-5-publish-issues`.
...
implements the mapping in the preceding paragraph. `plan-5-publish-issues` only
