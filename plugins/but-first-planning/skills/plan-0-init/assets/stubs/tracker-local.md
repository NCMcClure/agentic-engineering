...
`plan-5-publish-issues` in local mode simply transitions an issue's plan-tree
...
Re-run `plan-0-init` (or edit this file) to point at GitHub or another tracker. The
