 ...
 * back to localStorage so the page never breaks. The plan-6-edit skill reads the
...
(() => {
  ...
  // but if the leaf guess is wrong plan-6-edit disambiguates on disk (index.md).
  const pageSpecFile = () => {
    const path = pageKey();
