...
if (!A || !A.root || !A.skillDir || !A.brief) {
  throw new Error('args must be an object: {root: <absolute repo root>, skillDir: <plan-1-specify skill dir>, brief: <inline text or absolute path>, context?, sourcePaths?, language?, today?}')
}
...
rules live in the plan-1-specify skill at ${SKILL}/ (SKILL.md, PROGRESSIVE-DISCLOSURE.md,
...
return {
  ...
  openQuestions: judged.openQuestions, // the hand-off contract to plan-2-grill-spec / autopilot
  verifier: vres,
